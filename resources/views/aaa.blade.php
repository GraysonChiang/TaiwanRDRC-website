...
<div id="page-wrapper">
    ...
    <section id="two" class="wrapper alt style2">
        <section class="spotlight">
            <div class="image"><img src="{{ URL::asset('images/pic01.jpg')}}" alt=""/></div>
            <div class="content">
        ...
        <section class="spotlight">
            <div class="image"><img src="{{ URL::asset('images/pic02.jpg')}}" alt=""/></div>
            <div class="content">
        ...
        <section class="spotlight">
            <div class="image"><img src="{{ URL::asset('images/pic03.jpg')}}" alt=""/></div>
            <div class="content">
